  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless carsharing with CAR - Manage profiles, book vehicles, track usage, and assess performance, all in one central place."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless carsharing with CAR - Manage profiles, book vehicles, track usage, and assess performance, all in one central place.`}
            </Text>
            <Box
